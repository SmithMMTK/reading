...
[Launch Exercise](https://microsoftlearning.github.io/mslearn-fabric/Instructions/Labs/06a-data-warehouse-load.html)


[sales.csv](https://github.com/MicrosoftLearning/dp-data/raw/main/sales.csv)
...
```sql
 ...
 AS
 SELECT * FROM dw_lakehouse.[dbo].[staging_sales];
```
